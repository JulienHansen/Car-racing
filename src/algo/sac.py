#!/usr/bin/env python3
"""
Self-contained SAC implementation for the CarRacing-v3 environment.
...
class SACAgent:
    ...
    def update(self):
        ...
        with torch.no_grad():
            ...
            q_target = reward_batch + (1 - done_batch) * self.gamma * (q_next - self.alpha * next_log_prob)
...
def train():
    ...
    # Use tqdm for progress tracking over episodes.
